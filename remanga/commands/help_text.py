...
# never chosen actually runs. Not the same list since `init-config` joined
# the registry as an opt-in step, and a --help that conflated them would
# promise a default order that no project has.
