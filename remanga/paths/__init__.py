...
from .metadata import (
    ...
    get_project_metadata_path, list_projects, load_project_metadata, read_manifest,
    save_project_metadata, update_manifest_chapter,
)
...
__all__ = [
    ...
    "update_manifest_chapter", "list_projects",
    # review
