...
independently activated (PackageConfig.panels_zip_active/panels_pdf_active/
...
def is_up_to_date(config: CropperConfig, chapter_dir: Path) -> bool:
    ...
    pdf_ok = not config.package.panels_pdf_active or any((chapter_dir / "panels_pdf").glob("panels_*.pdf"))
